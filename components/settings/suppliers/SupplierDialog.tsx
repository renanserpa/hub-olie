...
const SupplierDialog: React.FC<SupplierDialogProps> = ({ isOpen, onClose, onSave, supplier, isSaving }) => {
    ...
    const inputStyle = "mt-1 w-full px-3 py-2 border border-border rounded-xl shadow-sm bg-background dark:bg-dark-background focus:outline-none focus:ring-2 focus:ring-primary/50";
