...
export function usePurchaseOrders() {
    ...
    const fetchOrders = useCallback(async () => {
        try {
            const data = await dataService.getCollection<PurchaseOrder>('purchase_orders', '*, supplier:suppliers(*)');
    ...
    useEffect(() => {
        ...
        const poListener = dataService.listenToCollection('purchase_orders', '*, supplier:suppliers(*)', setPurchaseOrders);
