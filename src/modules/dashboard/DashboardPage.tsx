    ...
    <main className="space-y-6" aria-labelledby="dashboard-heading">
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Acompanhe hoje os pedidos, produção e entregas do ateliê.</p>
        </div>
        <Link to="/orders">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4" aria-label="Indicadores do dia">
        {isLoading ? (
          <>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <section
          className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 md:col-span-2"
        ...
        >
          ...
          <div className="mt-4 space-y-3">
            {isLoading ? (
              ...
              <p className="text-sm text-slate-600">Nenhum pedido encontrado nos filtros atuais. Ajuste o período ou cadastre um novo pedido.</p>
            )}
          </div>
        </section>
              ...
              <>
                <div className="flex items-center justify-between rounded-xl border border-amber-100 bg-amber-50 px-3 py-2 text-sm dark:border-amber-900/60 dark:bg-amber-950/40">
                  <div>
                    ...
                    <p className="text-xs text-amber-700/80 dark:text-amber-200">Contamos pedidos com entrega prevista no passado.</p>
                  </div>
