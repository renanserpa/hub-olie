...
// CREDENCIAIS HARDCODED (Modo Rescue v22 - Acesso Prioritário)
...
export const supabase = createClient(PROJECT_URL, ANON_KEY, {
    auth: {
        // Alteramos a chave para 'v22' para invalidar qualquer sessão anterior que esteja travando o loop de login
