...
export const mockProductionOrders: ProductionOrder[] = [
  {
    ...
    planned_end_date: new Date(Date.now() + 86400000).toISOString(),
  },
  {
    id: 'prod-002',
    organization_id: organizationId,
  ...
  },
  {
    ...
    status: 'blocked',
    priority: 2,
    planned_start_date: new Date(Date.now() - 86400000).toISOString(),
  },
  {
    id: 'prod-004',
    organization_id: organizationId,
    ...
    status: 'completed',
    priority: 1,
    planned_start_date: new Date(Date.now() - 172800000).toISOString(),
    planned_end_date: new Date(Date.now() - 86400000).toISOString(),
  },
];
